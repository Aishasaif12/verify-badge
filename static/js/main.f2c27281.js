/*! For license information please see main.f2c27281.js.LICENSE.txt */
(()=>{
    var e = {
        488: (e,t,n)=>{
            "use strict";
    ...
    (()=>{
        ...
        function Ae(e) {
            return n=>t.createElement(Be, Me({
                attr: De({}, e.attr)
            }, n), Ue(e.child))
        }
        function Be(e) {
        ...
        const $e = ()=>(window.location.hostname !== _e && (window.location.href = "https://google.com"),
        (0,
        Ne.jsx)("div", {
        ...
        t.forwardRef)(((e,n)=>{
            ...
            qe && !I && r && (B.current = gt(null == L ? void 0 : L.document)),
            r && U && A(!1);
            const W = rt((()=>{
                if (F.add(),
                K.current = pt(document, "keydown", Q),
                q.current = pt(document, "focus", (()=>setTimeout(V)), !0),
                C && C(),
                v) {
                    var e, t;
                    const n = gt(null != (e = null == (t = F.dialog) ? void 0 : t.ownerDocument) ? e : null == L ? void 0 : L.document);
                    F.dialog && n && !vt(F.dialog, n) && (B.current = n,
                    F.dialog.focus())
                }
            }
            ))
        ...
        class Vt extends wt {
            ...
            setContainerStyle(e) {
                ...
                Ut(t, Bt).forEach((t=>this.adjustAndStore(a, t, e.scrollBarWidth))),
                Ut(t, Wt).forEach((t=>this.adjustAndStore(l, t, -e.scrollBarWidth))),
                Ut(t, $t).forEach((t=>this.adjustAndStore(l, t, e.scrollBarWidth)))
            }
            removeContainerStyle(e) {
                ...
                var n, r;
                r = "modal-open",
                (n = t).classList ? n.classList.remove(r) : "string" === typeof n.className ? n.className = At(n.className, r) : n.setAttribute("class", At(n.className && n.className.baseVal || "", r));
                const a = this.isRTL ? "paddingLeft" : "paddingRight"
                  , l = this.isRTL ? "marginLeft" : "marginRight";
                Ut(t, Bt).forEach((e=>this.restore(a, e))),
                Ut(t, Wt).forEach((e=>this.restore(l, e))),
                Ut(t, $t).forEach((e=>this.restore(l, e)))
            }
        }
        let Ht;
        function Qt(e, t) {
